...
rmarkdown::render(input = 'ea_research_priorities_opportunities_rjs_sc_notes_within.Rmd',
                  output_file="../docs/ea_research_priorities_opportunities_rjs_sc_notes_within.html",
                  output_yaml = "self_contained.yml")
...
Hosted [HERE](https://daaronr.github.io/reinstein_web/ea_research_priorities_opportunities_rjs_sc_notes_within.html)

Also see the ‘curated links’ [HERE](https://github.com/daaronr/reinstein_web/blob/main/docs/ea_research_priorities_key_links.md)
...
![](images/rethink_priorities.png){width="300"}
...
[![From barriers to effective giving presentation](images/barriers_presentation_slide.png){width="500"}](https://daaronr.github.io/dualprocess/GPI_barriers_evidence_sc.html#/4/3)
...
[![Open phil key impactful questions](images/open_phil_questions.png){width="600"}](https://www.openphilanthropy.org/blog/technical-and-philosophical-questions-might-affect-our-grantmaking#top)
...
## Rethink Priorities, Happier Lives institute, Animal Charity Evaluators 
...
Other humanities - some possibilities discussed [here](https://forum.effectivealtruism.org/posts/oTJ5vMNwdWiHj2iKL/humanities-research-ideas-for-longtermists) (considering 'longtermism') 
...
# Questions/answers from talk

Short of leaving academia, how can academics optimize their impact despite academia’s limitations? (Relatedly, what of what academics tend to do is low impact and should be reconsidered?)
 +1

*Response (summarizing my vocal answer):*

- Contact and work with EA orgs like Rethink Priorities and Global Priorities Institude/FHI
- Read and consider how your work relates to the “Agendas and research questions”  of places like Open Philanthropy
- Post and comment on places like the EA Forum
- Think about the “Importance, tractibility, neglectedness” framework ...a
  - and consider how you might pivot towards more important, tractible and neglected areas (e.g., working on health outcomes in larger and poorer countries/regions perhaps)
- Make a ‘public constantly updated and readable’ version of your research and do Open Science; Explain your work with ‘public teaching’ resources integrating teaching and research.
- If you are doing research just to ‘get a top publication’, reconsider this
     - Consider writing the ‘second or third paper’ that provides the evidence that is needed
- See the advice from  “80000 hours”


Question: Like the process of building a start-up company when research reaches a certain stage of development in academia, is there a similar/parallel route for research funded by EA? 
Response: As a participant reminded me, for charitable activities there is the  Incubation Program - CHARITY ENTREPRENEURSHIP, and some other things mentioned below

 An app was mentioned as a route for research insights being applied in the wider world. 
I wonder, funding the app, are there funding routes within EA or would it eventually require funding from private equity/venture capital, and would this then distort the original aim of the app? (answer - Charity Incubator / charityentrepeneurship.com / sparkwave.tech)
...
There are definitely some workshops and trainings, such as those run by GPI. 
Here is a list of syllabi: https://docs.google.com/document/d/1kYNd7URm0TPClM4iDIM_cjtpsOK9Vp1_HDbR2tMzVTQ/edit
...
Can we get involved with rethink priorities part time? (Michal Strahilevitz)
Response (summarizing my vocal answer): 
You could reach out to us to discuss your research and our work, definitely!
Also, we have and do hire people part-time and on a project basis
